...
begin
  ...
  Resultado := (((((((Ano mod 12) + (Mes * 31)) + (Dia * 24)) + (Hora * 60)) +
                     (Minuto * 60)) + (Segundo * 31)) + (MSegundo div 5));               
  Result := trunc(Resultado);
end;
...
begin
  EditMC1.Text := IntToStr(NovoNumero);
end;
