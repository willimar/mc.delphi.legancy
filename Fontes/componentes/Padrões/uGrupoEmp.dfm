object _frmGrupoEmp: T_frmGrupoEmp
  Left = 120
  Top = 132
  ...
  object Panel3: TPanel
    ...
    object ToolBar1: TToolBar
      ...
      object bitExcluir: TSpeedButton
        ...
        Height = 33
        Cursor = crHandPoint
        Hint = 'Exclui o grupo selecionado'
        Caption = '&Excluir'
        Flat = True
        Glyph.Data = {
          42020000424D4202000000000000420000002800000010000000100000000100
      ...
      object bitImprimir: TSpeedButton
        ...
        Height = 33
        Cursor = crHandPoint
        Hint = 'Imprime o grupo selecionado'
        Caption = '&Imprimir'
        Flat = True
        Glyph.Data = {
  ...
  object Panel5: TPanel
    ...
    object Panel6: TPanel
      ...
      object dbeCodigo: TDBEdit
        ...
        Width = 81
        Height = 21
        Hint = 'C'#243'digo de identifica'#231#227'o do Grupo'
        DataField = 'CodGrupoEmp'
        DataSource = dsGrupoEmp
        TabOrder = 0
      end
  ...
  object dsrGrupoEmp: TDataSource
    AutoEdit = False
    DataSet = cdsGrupoEmp
    OnDataChange = dsrGrupoEmpDataChange
    Left = 17
    Top = 59
  end
  object cdsGrupoEmp: TClientDataSet
    Active = True
    Aggregates = <>
    CommandText = 
      'SELECT CodGrupoEmp "C'#243'digo", Descricao "Descri'#231#227'o" FROM tbgrupoe' +
      'mp'
    Params = <>
    ProviderName = 'dspGrupoEmp'
    Left = 48
    Top = 59
  end
  object dspGrupoEmp: TDataSetProvider
    DataSet = tbGrupoEmpresa
    ResolveToDataSet = True
    Options = [poAllowCommandText]
    Left = 80
    Top = 59
  end
  object tbGrupoEmpresa: TZQuery
  ...
  object dsGrupoEmp: TDataSource
    AutoEdit = False
    DataSet = tbGrupoEmp
    Left = 64
    Top = 133
  end
  object tbGrupoEmp: TZQuery
    Connection = DM.Connection
    RequestLive = True
    CachedUpdates = False
    AfterInsert = tbGrupoEmpAfterInsert
    Active = True
    SQL.Strings = (
      'SELECT *  FROM tbgrupoemp')
    ParamCheck = True
    Params = <>
    ShowRecordTypes = [utModified, utInserted, utUnmodified]
    Left = 64
