...
uses
  ...
  TFlatCheckBoxUnit, DBCtrls, db, Criptografia;
...
procedure TDBFlatCheckBox.Notification(AComponent : TComponent; Operation : TOperation);
begin
...
procedure TDBFlatCheckBox.SetDataField(Value : String);
begin
...
procedure TDBFlatCheckBox.Click;
begin
  FDataLink.Modified;
  inherited Click;
  try
...
procedure Register;
begin
  RegisterComponents('DBFlatStyle', [TDBFlatCheckBox]);
end;
