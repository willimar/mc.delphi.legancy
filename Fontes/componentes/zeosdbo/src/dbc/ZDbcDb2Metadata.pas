...
uses
  Types, Classes, SysUtils, ZSysUtils, ZDbcIntfs, ZDbcMetadata, ZTokenizer,
  ZCompatibility, ZGenericSqlAnalyser, ZDbcConnection, ZDbcDB2;

type

  {** Implements Db2 Database Metadata. }
  TZDb2DatabaseMetadata = class(TZAbstractDatabaseMetadata)
  private
...
constructor TZDb2DatabaseMetadata.Create(Connection: TZAbstractConnection;
...
destructor TZDb2DatabaseMetadata.Destroy;
begin
  inherited Destroy;
end;
...
function TZDb2DatabaseMetadata.GetDatabaseProductName: string;
begin
...
function TZDb2DatabaseMetadata.GetDatabaseProductVersion: string;
begin
  Result := '6.0+';
end;
...
function TZDb2DatabaseMetadata.GetDriverName: string;
begin
...
function TZDb2DatabaseMetadata.GetDriverMajorVersion: Integer;
begin
  Result := 1;
end;
...
function TZDb2DatabaseMetadata.GetDriverMinorVersion: Integer;
begin
  Result := 0;
end;
...
function TZDb2DatabaseMetadata.UsesLocalFilePerTable: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.SupportsMixedCaseIdentifiers: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.StoresUpperCaseIdentifiers: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.StoresLowerCaseIdentifiers: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.StoresMixedCaseIdentifiers: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.SupportsMixedCaseQuotedIdentifiers: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.StoresUpperCaseQuotedIdentifiers: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.StoresLowerCaseQuotedIdentifiers: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.StoresMixedCaseQuotedIdentifiers: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.GetSQLKeywords: string;
begin
...
function TZDb2DatabaseMetadata.GetNumericFunctions: string;
begin
  Result := '';
end;
...
function TZDb2DatabaseMetadata.GetStringFunctions: string;
begin
  Result := '';
end;
...
function TZDb2DatabaseMetadata.GetSystemFunctions: string;
begin
  Result := '';
end;
...
function TZDb2DatabaseMetadata.GetTimeDateFunctions: string;
begin
  Result := '';
end;
...
function TZDb2DatabaseMetadata.GetSearchStringEscape: string;
begin
  Result := '\';
end;
...
function TZDb2DatabaseMetadata.GetExtraNameCharacters: string;
begin
  Result := '$';
end;
...
function TZDb2DatabaseMetadata.SupportsExpressionsInOrderBy: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.SupportsOrderByUnrelated: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.SupportsGroupBy: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.SupportsGroupByUnrelated: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.SupportsGroupByBeyondSelect: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.SupportsIntegrityEnhancementFacility: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.GetSchemaTerm: string;
begin
  Result := '';
end;
...
function TZDb2DatabaseMetadata.GetProcedureTerm: string;
begin
  Result := 'PROCEDURE';
end;
...
function TZDb2DatabaseMetadata.GetCatalogTerm: string;
begin
  Result := '';
end;
...
function TZDb2DatabaseMetadata.GetCatalogSeparator: string;
begin
  Result := '';
end;
...
function TZDb2DatabaseMetadata.SupportsSchemasInDataManipulation: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.SupportsSchemasInProcedureCalls: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.SupportsSchemasInTableDefinitions: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.SupportsSchemasInIndexDefinitions: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.SupportsSchemasInPrivilegeDefinitions: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.SupportsCatalogsInDataManipulation: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.SupportsCatalogsInProcedureCalls: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.SupportsCatalogsInTableDefinitions: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.SupportsCatalogsInIndexDefinitions: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.SupportsCatalogsInPrivilegeDefinitions: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.SupportsPositionedDelete: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.SupportsPositionedUpdate: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.SupportsSelectForUpdate: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.SupportsStoredProcedures: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.SupportsSubqueriesInComparisons: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.SupportsSubqueriesInExists: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.SupportsSubqueriesInIns: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.SupportsSubqueriesInQuantifieds: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.SupportsCorrelatedSubqueries: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.SupportsUnion: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.SupportsUnionAll: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.SupportsOpenCursorsAcrossCommit: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.SupportsOpenCursorsAcrossRollback: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.SupportsOpenStatementsAcrossCommit: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.SupportsOpenStatementsAcrossRollback: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.GetMaxBinaryLiteralLength: Integer;
begin
  Result := 0;
end;
...
function TZDb2DatabaseMetadata.GetMaxCharLiteralLength: Integer;
begin
  Result := 1024;
end;
...
function TZDb2DatabaseMetadata.GetMaxColumnNameLength: Integer;
begin
  Result := 31;
end;
...
function TZDb2DatabaseMetadata.GetMaxColumnsInGroupBy: Integer;
begin
  Result := 16;
end;
...
function TZDb2DatabaseMetadata.GetMaxColumnsInIndex: Integer;
begin
  Result := 16;
end;
...
function TZDb2DatabaseMetadata.GetMaxColumnsInOrderBy: Integer;
begin
  Result := 16;
end;
...
function TZDb2DatabaseMetadata.GetMaxColumnsInSelect: Integer;
begin
  Result := 32767;
end;
...
function TZDb2DatabaseMetadata.GetMaxColumnsInTable: Integer;
begin
  Result := 32767;
end;
...
function TZDb2DatabaseMetadata.GetMaxConnections: Integer;
begin
  Result := 0;
end;
...
function TZDb2DatabaseMetadata.GetMaxCursorNameLength: Integer;
begin
  Result := 31;
end;
...
function TZDb2DatabaseMetadata.GetMaxIndexLength: Integer;
begin
  Result := 198;
end;
...
function TZDb2DatabaseMetadata.GetMaxSchemaNameLength: Integer;
begin
  Result := 0;
end;
...
function TZDb2DatabaseMetadata.GetMaxProcedureNameLength: Integer;
begin
  Result := 0;
end;
...
function TZDb2DatabaseMetadata.GetMaxCatalogNameLength: Integer;
begin
  Result := 27;
end;
...
function TZDb2DatabaseMetadata.GetMaxRowSize: Integer;
begin
  Result := 32664;
end;
...
function TZDb2DatabaseMetadata.DoesMaxRowSizeIncludeBlobs: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.GetMaxStatementLength: Integer;
begin
  Result := 640;
end;
...
function TZDb2DatabaseMetadata.GetMaxStatements: Integer;
begin
  Result := 0;
end;
...
function TZDb2DatabaseMetadata.GetMaxTableNameLength: Integer;
begin
  Result := 31;
end;
...
function TZDb2DatabaseMetadata.GetMaxTablesInSelect: Integer;
begin
  Result := 16;
end;
...
function TZDb2DatabaseMetadata.GetMaxUserNameLength: Integer;
begin
  Result := 31;
end;
...
function TZDb2DatabaseMetadata.GetDefaultTransactionIsolation:
...
function TZDb2DatabaseMetadata.SupportsTransactions: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.SupportsTransactionIsolationLevel(
...
function TZDb2DatabaseMetadata.
...
function TZDb2DatabaseMetadata.DataDefinitionCausesTransactionCommit: Boolean;
begin
  Result := True;
end;
...
function TZDb2DatabaseMetadata.DataDefinitionIgnoredInTransactions: Boolean;
begin
  Result := False;
end;
...
function TZDb2DatabaseMetadata.GetProcedures(Catalog: string;
...
begin
 { TargetResultSet := inherited GetProcedures(Catalog, SchemaPattern,
  ...
  Sql := 'SELECT RDB$PROCEDURE_NAME, RDB$PROCEDURE_OUTPUTS, RDB$DESCRIPTION '+
    ' FROM RDB$PROCEDURES WHERE ' + ProcedureNamePattern + ' 1 = 1 ';
...
function TZDb2DatabaseMetadata.GetProcedureColumns(Catalog: string;
...
{  TargetResultSet := inherited GetProcedureColumns(Catalog, SchemaPattern,
  ...
  if StrPos(PChar(SeverVersion), 'Interbase 5') <> nil then
    Sql := ' SELECT P.RDB$PROCEDURE_NAME, PP.RDB$PARAMETER_NAME, PP.RDB$PARAMETER_TYPE, ' +
      ...
      ' FROM RDB$PROCEDURES P, RDB$PROCEDURE_PARAMETERS PP, RDB$FIELDS F ' +
	    ' WHERE ' + ProcedureNamePattern + ColumnNamePattern +
      ' P.RDB$PROCEDURE_NAME = PP.RDB$PROCEDURE_NAME and PP.RDB$FIELD_SOURCE = F.RDB$FIELD_NAME ' +
	    ' ORDER BY  P.RDB$PROCEDURE_NAME, PP.RDB$PARAMETER_TYPE desc, PP.RDB$PARAMETER_NUMBER'
  else
    Sql := ' SELECT P.RDB$PROCEDURE_NAME, PP.RDB$PARAMETER_NAME, PP.RDB$PARAMETER_TYPE, ' +
      ' F.RDB$FIELD_TYPE, F.RDB$FIELD_SUB_TYPE, F.RDB$FIELD_SCALE, F.RDB$FIELD_LENGTH, ' +
...
function TZDb2DatabaseMetadata.GetTables(Catalog: string;
...
{  TargetResultSet := inherited GetTables(Catalog, SchemaPattern,
  ...
  Sql := 'SELECT DISTINCT RDB$RELATION_NAME, RDB$SYSTEM_FLAG, RDB$VIEW_CONTEXT ' +
    ' FROM RDB$RELATION_FIELDS ' +
    ' WHERE ' + TableNamePattern + ' 1 = 1 ';
  ...
  begin
    ...
    //ViewContext := TempResultSet.GetIntByName('RDB$VIEW_CONTEXT');
    ...
    TargetResultSet.UpdateNull(1);
    TargetResultSet.UpdateNull(2);
    TargetResultSet.UpdateString(3, TempResultSet.GetStringByName('RDB$RELATION_NAME'));
...
function TZDb2DatabaseMetadata.GetSchemas: IZResultSet;
//var
//  Key: string;
begin
{  Key := 'get-schemas';
...
function TZDb2DatabaseMetadata.GetCatalogs: IZResultSet;
//var
//  Key: string;
begin
{  Key := 'get-catalogs';
...
function TZDb2DatabaseMetadata.GetTableTypes: IZResultSet;
{const
...
function TZDb2DatabaseMetadata.GetColumns(Catalog: string;
  SchemaPattern: string; TableNamePattern: string;
  ColumnNamePattern: string): IZResultSet;
{var
...
{  TargetResultSet := inherited GetColumns(Catalog, SchemaPattern,
  ...
  if StrPos(PChar(SeverVersion), 'Interbase 5') <> nil then
    Sql := 'SELECT a.RDB$RELATION_NAME, a.RDB$FIELD_NAME, a.RDB$FIELD_POSITION,'+
      ...
      ' WHERE ' + ColumnNamePattern + TableNamePattern +
...
function TZDb2DatabaseMetadata.GetColumnPrivileges(Catalog: string;
...
function TZDb2DatabaseMetadata.GetTablePrivileges(Catalog: string;
...
{  TargetResultSet := inherited GetTablePrivileges(Catalog, SchemaPattern,
  ...
  Sql := 'SELECT a.RDB$USER, a.RDB$GRANTOR, a.RDB$PRIVILEGE, a.RDB$GRANT_OPTION, ' +
    ...
    ' WHERE a.RDB$OBJECT_TYPE = b.RDB$TYPE AND ' +
    ' b.RDB$TYPE_NAME IN (''RELATION'', ''VIEW'', ''COMPUTED_FIELD'', ''FIELD'' ) AND ' +
    TableNamePattern + ' a.RDB$FIELD_NAME IS NULL ' +
...
function TZDb2DatabaseMetadata.GetBestRowIdentifier(Catalog: string;
...
{  TargetResultSet := inherited GetBestRowIdentifier(Catalog, Schema,
  ...
  TempResultSet := GetConnection.CreateStatement.ExecuteQuery(
    ' SELECT distinct c.RDB$FIELD_NAME ' +
    ' FROM RDB$RELATION_FIELDS a, RDB$INDICES b, RDB$INDEX_SEGMENTS c ' +
    ' WHERE a.RDB$RELATION_NAME = b.RDB$RELATION_NAME and ' +
    Table +
    ' c.RDB$INDEX_NAME = b.RDB$INDEX_NAME and b.RDB$UNIQUE_FLAG = 1 ' +
    ' ORDER BY a.RDB$RELATION_NAME, a.RDB$FIELD_NAME ');
  ...
  if StrPos(PChar(SeverVersion), 'Interbase 5') <> nil then
    Sql := 'SELECT a.RDB$RELATION_NAME, a.RDB$FIELD_NAME, a.RDB$FIELD_POSITION, ' +
      ...
      ' WHERE ' + Table + 'a.RDB$FIELD_SOURCE = b.RDB$FIELD_NAME '
  else
    Sql := 'SELECT a.RDB$RELATION_NAME, a.RDB$FIELD_NAME, a.RDB$FIELD_POSITION, ' +
      ' b. RDB$FIELD_LENGTH, b.RDB$FIELD_SCALE, c.RDB$TYPE_NAME, ' +
...
function TZDb2DatabaseMetadata.GetVersionColumns(Catalog: string;
...
function TZDb2DatabaseMetadata.GetPrimaryKeys(Catalog: string;
  Schema: string; Table: string): IZResultSet;
//var
//  Key: string;
begin
{  Key := Format('get-primary-keys:%s:%s:%s',
  ...
  begin
    ...
    Result := GetConnection.CreateStatement.ExecuteQuery(
      ' SELECT null as TABLE_CAT, null as TABLE_SCHEM, a.RDB$RELATION_NAME as TABLE_NAME, ' +
      ...
      ' WHERE RDB$CONSTRAINT_TYPE = ''PRIMARY KEY'' AND ' + Table +
...
function TZDb2DatabaseMetadata.GetImportedKeys(Catalog: string;
  Schema: string; Table: string): IZResultSet;
{var
  Sql: string;
  TempResultSet: IZResultSet;
...
{  TargetResultSet := (inherited GetImportedKeys(Catalog, Schema, Table)) as IZVirtualResultSet;
  ...
  Table := ConstructNameCondition(Table, 'RELC_FOR.RDB$RELATION_NAME');
    ...
    Sql := 'SELECT ' +
	   ...
	   ' WHERE ' +
	   ' RELC_FOR.RDB$CONSTRAINT_TYPE = ''FOREIGN KEY'' and ' + Table +
...
function TZDb2DatabaseMetadata.GetExportedKeys(Catalog: string;
  Schema: string; Table: string): IZResultSet;
{var
  Sql: string;
  TempResultSet: IZResultSet;
...
{  TargetResultSet := (inherited GetExportedKeys(Catalog, Schema, Table)) as IZVirtualResultSet;
  ...
  Sql := ' SELECT ' +
   ...
   ' RDB$INDEX_SEGMENTS IS_PRIM, RDB$INDEX_SEGMENTS IS_FOR ' +
   ' WHERE ' +
   ' RC_PRIM.RDB$CONSTRAINT_TYPE = ''PRIMARY KEY'' and ' + Table +
...
function TZDb2DatabaseMetadata.GetCrossReference(PrimaryCatalog: string;
...
function TZDb2DatabaseMetadata.GetTypeInfo: IZResultSet;
{var
  SQL: string;
  TargetResultSet: IZVirtualResultSet;
...
function TZDb2DatabaseMetadata.GetIndexInfo(Catalog: string;
...
{  TargetResultSet := inherited GetIndexInfo(Catalog, Schema, Table, Unique,
  ...
  SQL :=  ' SELECT I.RDB$RELATION_NAME, I.RDB$UNIQUE_FLAG, I.RDB$INDEX_NAME, ' +
    ...
    ' FROM RDB$INDICES I, RDB$INDEX_SEGMENTS ISGMT, RDB$PAGES P, RDB$RELATIONS R '+
	  ' WHERE ';
...
function TZDb2DatabaseMetadata.SupportsResultSetType(
...
function TZDb2DatabaseMetadata.SupportsResultSetConcurrency(
...
function TZDb2DatabaseMetadata.GetUDTs(Catalog: string;
...
function TZDb2DatabaseMetadata.GetTokenizer: IZTokenizer;
begin
...
function TZDb2DatabaseMetadata.GetStatementAnalyser: IZStatementAnalyser;
begin
