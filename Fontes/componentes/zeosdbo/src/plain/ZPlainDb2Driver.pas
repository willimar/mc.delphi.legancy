...
{************** Plain API Function types definition *************}
 ...
 {** Represents a generic interface to DB2 native API. }
  IZDb2PlainDriver = interface (IZPlainDriver)
    ...
    function SQLAllocConnect(henv: SQLHENV; phdbc: PSQLHDBC): SQLRETURN;
    function SQLAllocEnv(phenv: PSQLHENV): SQLRETURN;
    function SQLAllocStmt(hdbc: SQLHDBC; phstmt: PSQLHSTMT): SQLRETURN;
    ...
    function SQLCancel(hstmt: SQLHSTMT): SQLRETURN;
    ...
    function SQLDisconnect(hdbc: SQLHDBC): SQLRETURN;
    ...
    function SQLExecute(hstmt: SQLHSTMT): SQLRETURN;
    function SQLFetch(hstmt: SQLHSTMT): SQLRETURN;
    function SQLFreeConnect(hdbc: SQLHDBC): SQLRETURN;
    function SQLFreeEnv(henv: SQLHENV): SQLRETURN;
    function SQLFreeStmt(hstmt: SQLHSTMT; fOption: SQLUSMALLINT): SQLRETURN;
    function SQLCloseCursor(hStmt: SQLHSTMT): SQLRETURN;
    ...
    function SQLGetData(hstmt: SQLHSTMT; icol: SQLUSMALLINT;
      fCType: SQLSMALLINT; rgbValue: SQLPOINTER; cbValueMax: SQLINTEGER;
      pcbValue: PSQLINTEGER): SQLRETURN;
    function SQLNumResultCols(hstmt: SQLHSTMT; pccol: PSQLSMALLINT): SQLRETURN;
    function SQLPrepare(hstmt: SQLHSTMT; szSqlStr: PSQLCHAR;
      cbSqlStr: SQLINTEGER): SQLRETURN;
    function SQLRowCount(hstmt: SQLHSTMT; pcrow: PSQLINTEGER): SQLRETURN;
    ...
    function SQLParamData(hstmt: SQLHSTMT; prgbValue: SQLPOINTER): SQLRETURN;
    ...
    function SQLGetTypeInfo(hstmt: SQLHSTMT; fSqlType: SQLSMALLINT): SQLRETURN;
